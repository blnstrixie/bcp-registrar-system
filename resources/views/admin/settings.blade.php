            ...
            <div class="tab-content-container">
              ...
              <div class="input-pair">
                <div class="input-group">
                  ...
                  <input type="text" name="firstname" id="firstname" autocomplete="on" value="Trixie">
                </div>
        
                <div class="input-group">
                  <div class="settings-label"> Last Name </div>
                  <input type="text" name="lastname" id="lastname" autocomplete="on" value="Belnas">
                </div>
              </div>
              ...
              <div class="input-pair">
                <div class="input-group">
                  ...
                  <input type="text" name="middlename" id="middlename" autocomplete="on" value="Gamazon">
                </div>
        ...
        -->
          ...
          <div class="tab-content-container">
            ...
            <div class="input-group">
              ...
              <input type="text" name="email" id="email-address" autocomplete="off" value="trixiebelnas7@gmail.com">
            </div>
            ...
            <div class="input-pair">
              ...
              <div class="settings-label"> Username </div>
                <input type="text" name="username" id="username" autocomplete="off" value="Trixie">
              </div>
