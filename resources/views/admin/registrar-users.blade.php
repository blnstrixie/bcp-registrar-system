    ...
    <main>
      <div class="content-title">
            ...
            <div id="overlay" class="overlay">
              <div class="overlay-content">
                ...
                <div class="form">
                  ...
                  <div class="input-group">
                    <div class="settings-label"> Assigned Course </div>
                    <select name="assignedCourse" id="assignedCourse" autocomplete="off">
                      <option selected disabled>Select Course</option>
                      <option value="allcourses">All</option>
                      <option value="course1">Bachelor of Science in Information Systems</option>
            ...
            <table>
              ...
              <tbody id="myTable">
                        <tr>
                            <td data-label="Name">Anthony Formon Ehurango</td>
                            <td data-label="Username">Anthony</td>
                            <td data-label="Email">formon015@gmail.com</td>
