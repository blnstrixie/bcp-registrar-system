    ...
    <main class="container">
      <div class="tabs">
        ...
        <div class="tab-content" id="tab1-content">
          <form action="{{ route('prof', ['id' => $user->id]) }}" class="form" method="POST" enctype="multipart/form-data" id="profileForm">
            @csrf
        ...
        <div class="tab-content" id="tab2-content">
          ...
          @endif
          <form action="{{ route('acc', ['id' => $user->id]) }}" class="form" method="POST" id="profileForm2">
            @csrf
          <div class="tab-content-container">
            <div class="content-title">
