...
<html lang="en">
  <head>
    ...
    <title> Students List per Year Level </title>
  </head>
      ...
      <div class="filter-row">
        ...
        <div id="dataDisplay" class="select-group">
          <select name="year-level" id="year-level">
            ...
            <option> Bachelor of Science in Criminilogy </option>
          </select>
      ...
      <table>
        ...
        <tbody id="myTable">
            <tr>
              ...
              <td data-label="Year Level">Bachelor of Science in Information System</td>
              <td data-label="Section">Bulacan BSIS 1001</td>
