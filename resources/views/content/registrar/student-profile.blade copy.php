...
@section('page-content')
    ...
    <div class="tabs">
        ...
        <div class="tab-content" id="tab3-content">
            ...
            <a href="{{ route('documents.show-tor', ['id' => $student->studentNum]) }}" target="_blank">
            ...
            <div class="tab-content-container">
                <div class="student-info">
                    ...
                    <div class="info-group">
                        <div class="label"> Section&#58; </div>
                        <div class="data"> {{ $section->section_name }} </div>
                    </div>
            ...
            <div class="grades">
                ...
                @foreach ($subjectForYearLevel as $studSubj)
                    ...
                    @endphp
                @endforeach
                <a href="{{ route('printsSheet', ['studentNum' => $student->studentNum, 'year' => $year]) }}"
                    target="_blank">
                                    ...
                                    <td data-label="Action">
                                        ...
                                        <form action="{{ route('update-grade', ['id' => $grade->id]) }}" method="POST"
                                            ...
                                            <button class="save-btn"
                                                style="display: none; border-radius: 5px; padding: 7px 15px; cursor: pointer; font-size: 8px;">
            ...
            @if ($year !== 1)
                ...
                @endforeach
                <div class="grades">
                    <a href="{{ route('printsSheet', ['studentNum' => $student->studentNum, 'year' => $minusYear]) }}"
                        target="_blank">
                        <button class="print-btn">
                            Print <i class="fa-solid fa-print"></i>
                        </button>
                                ...
                                @if ($grade->subjects->academicterm_id === 1)
                                    <tr>
                                        ...
                                        <td data-label="Action">
                                            ...
                                            <form action="{{ route('update-grade', ['id' => $grade->id]) }}"
    ...
    @section('scripts')
        <script>
            $(document).ready(function() {
                ...
                $('#tab3').prop('checked', true).trigger('change');
